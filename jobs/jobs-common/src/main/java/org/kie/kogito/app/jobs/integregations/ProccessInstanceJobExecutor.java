...
public class ProccessInstanceJobExecutor implements JobExecutor {
    ...
    public ProccessInstanceJobExecutor(Processes processes, UnitOfWorkManager unitOfWorkManager) {
