...
public class JobDetailsEntityHelper {
    ...
    private static ObjectMapper getObjectMapperInstance() {
        if (OBJECT_MAPPER == null) {
            OBJECT_MAPPER = ObjectMapperFactory.get();
            ...
            kogitoCustomModule.addDeserializer(RecipientInstance.class, new RecipientInstanceDeserializer());
    ...
    public static JobDetailsEntity merge(JobDetails job, JobDetailsEntity instance) {
        ...
        ObjectNode recipient = getObjectMapperInstance().convertValue(job.getRecipient(), ObjectNode.class);
    ...
    public static JobDetails from(JobDetailsEntity instance) {
        ...
        RecipientInstance recipient = getObjectMapperInstance().convertValue(instance.getRecipient(), RecipientInstance.class);
